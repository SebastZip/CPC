class Administrador:
    def __init__(self, usuario, contrasenia, llaveMaestra, idAdministrador):
    ...
    # Getter para el atributo idAdministrador
    def get_idAdministrador(self):
        return self.__idAdministrador

    # Setter para el atributo idAdministrador
    def set_idAdministrador(self, idAdministrador):
        self.__idAdministrador = idAdministrador
